<?php
$info_menu = $this->info_menu; $jsonObj = $this->jsonObj; $perpage = $this->perpage; $pages = $this->page;
?>
    <div class="breadcumb-wrapper breadcumb-layout1 bg-fluid pt-200 pb-200"
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title"><?php echo $info_menu[0]['title'] ?></h1>
                                    ...
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="<?php echo URL.'/'.$this->_Convert->vn2latin($row['title'], true).'-product-'.base64_encode($row['id']).'.html' ?>" title="Add to cart" onclick="add_to_cart(<?php echo $row['id'] ?>)">
