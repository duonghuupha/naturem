        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6 col-xl-5 mb-30 mb-md-0">
                    <div class="product-big-img vs-carousel" data-slide-show="1" data-lg-slide-show="1"
                        ...
                        <div class="product-img"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-details-1.jpg" alt="Shop Image"
                                class="w-100"></div>
                        <div class="product-img"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-details-2.jpg" alt="Shop Image"
                                class="w-100"></div>
                        <div class="product-img"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-details-3.jpg" alt="Shop Image"
                                class="w-100"></div>
                        <div class="product-img"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-details-4.jpg" alt="Shop Image"
                                class="w-100"></div>
                        <div class="product-img"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-details-5.jpg" alt="Shop Image"
                                class="w-100"></div>
                    </div>
                    <div class="row gx-2 product-thumb-img pt-10 vs-carousel" data-slide-show="4" data-md-slide-show="3"
                        ...
                        <div class="col-auto">
                            <div class="thumb"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-thumb-1.jpg" alt="Thumb Image"
                                    class="w-100"></div>
                        </div>
                        <div class="col-auto">
                            <div class="thumb"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-thumb-2.jpg" alt="Thumb Image"
                                    class="w-100"></div>
                        </div>
                        <div class="col-auto">
                            <div class="thumb"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-thumb-3.jpg" alt="Thumb Image"
                                    class="w-100"></div>
                        </div>
                        <div class="col-auto">
                            <div class="thumb"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-thumb-4.jpg" alt="Thumb Image"
                                    class="w-100"></div>
                        </div>
                        <div class="col-auto">
                            <div class="thumb"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-thumb-5.jpg" alt="Thumb Image"
                                    class="w-100"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="product-content">
                        <h3 class="product-title mb-1">Fresh Peach Fruits</h3><span
                        ...
                        <div class="actions mb-4 pb-2">
                            <div class="quantity style2 me-4"><input type="number" class="qty-input" value="1" min="1"
                                    ...
                                    class="quantity-plus qut-btn"><i class="far fa-chevron-up"></i></button></div><a
                                href="cart.html" class="vs-btn shadow-none">Add To Cart</a>
                        </div>
                        <div class="product_meta"><span class="sku_wrapper">SKU: <span
                                    class="sku">D2300-3-1</span></span> <span class="posted_in">Category: <a href="#"
                                    rel="tag">Glassware</a> <a href="#" rel="tag">Fast Food</a></span></div>
                    </div>
                </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="vs-widget-recent-post">
                            <div class="recent-post d-flex align-items-center">
                                <div class="media-img"><img src="<?php echo URL.'/styles/' ?>assets/img/widget/recent-1.jpg" width="100" height="73"
                                ...
                                <div class="media-body pl-30">
                                    ...
                                    </h4><a href="#" class="text-theme fs-12">January 04, 2022</a>
                                </div>
                            </div>
                            <div class="recent-post d-flex align-items-center">
                                <div class="media-img"><img src="<?php echo URL.'/styles/' ?>assets/img/widget/recent-2.jpg" width="100" height="73"
                                        alt="Recent Post Image"></div>
                                <div class="media-body pl-30">
                                    <h4 class="recent-post-title h5 mb-0"><a href="blog.html">Keep Your Fruits frash</a>
                                    </h4><a href="#" class="text-theme fs-12">March 04, 2022</a>
                                </div>
                            </div>
                            <div class="recent-post d-flex align-items-center">
                                <div class="media-img"><img src="<?php echo URL.'/styles/' ?>assets/img/widget/recent-3.jpg" width="100" height="73"
                                        alt="Recent Post Image"></div>
                                <div class="media-body pl-30">
            ...
            <div class="tab-content mb-30" id="productTabContent">
                <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                    ...
                    <div class="row mt-30">
                        <div class="col-md-6 mb-30"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-desc-1.jpg" class="w-100"
                                alt="Shop Image"></div>
                        <div class="col-md-6 mb-30"><img src="<?php echo URL.'/styles/' ?>assets/img/shop/shop-desc-2.jpg" class="w-100"
                                alt="Shop Image"></div>
                    </div>
                ...
                <div class="tab-pane fade show active" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                        ...
                        <ul class="comment-list">
                            <li class="review vs-comment">
                                <div class="vs-post-comment">
                                    <div class="author-img"><img src="<?php echo URL.'/styles/' ?>assets/img/blog/comment-author-1.jpg"
                                    ...
                                    <div class="comment-content">
                                        ...
                                        <h4 class="name h5">Mark Jack</h4><span class="commented-on">22 April,
                                            2020</span>
                            ...
                            <li class="review vs-comment">
                                <div class="vs-post-comment">
                                    <div class="author-img"><img src="<?php echo URL.'/styles/' ?>assets/img/blog/comment-author-2.jpg"
                                            alt="Comment Author"></div>
                                    <div class="comment-content">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span
                                                style="width:100%">Rated <strong class="rating">5.00</strong> out of 5
                                                based on <span class="rating">1</span> customer rating</span></div>
                                        <h4 class="name h5">John Deo</h4><span class="commented-on">26 April,
                                            2020</span>
                                ...
                                <div class="vs-post-comment">
                                    ...
                                    <div class="comment-content">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span
                                                style="width:100%">Rated <strong class="rating">5.00</strong> out of 5
                                                based on <span class="rating">1</span> customer rating</span></div>
                                        <h4 class="name h5">Tara sing</h4><span class="commented-on">26 April,
                                            2020</span>
                                        <p class="text">Competently provide access to fully researched methods of
                                            empowerment without sticky models. Credibly morph front-end niche markets
                                            whereas 2.0 users. Enthusiastically seize team.</p>
                    ...
                    <div class="vs-comment-form pt-3">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-12 form-group mb-0"><textarea placeholder="Write a Message"
                                    class="form-control"></textarea></div>
                            <div class="col-md-6 form-group mb-0"><input type="text" placeholder="Your Name"
                                    class="form-control"></div>
                            <div class="col-md-6 form-group mb-0"><input type="text" placeholder="Your Email"
                                    class="form-control"></div>
                            <div class="col-12 form-group mt-3 mb-1"><input id="reviewcheck" name="reviewcheck"
                                    type="checkbox"> <label for="reviewcheck">Save my name, email, and website in this
                                    browser for the next time I comment.<span class="checkmark"></span></label></div>
                            <div class="col-12 form-group mb-0"><button class="vs-btn rounded-1">Post Review</button>
                            </div>
                        </div>
                    </div>
                </div>
