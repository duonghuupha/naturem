    ...
    <div class="vs-checkout-wrapper space-top space-md-bottom">
        <div class="container">
            ...
            <form id="fm-add-address" class="woocommerce-form-login">
                <input id="state_code" name="state_code" type="hidden" value="<?php echo $item[0]['code_state'] ?>"/>
                <input id="id_add" name="id_add" type="hidden" value="<?php echo $item[0]['id'] ?>"/>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label>Zip Code *</label> 
                            <input type="text" class="form-control" placeholder="Zip Code" onkeypress="validate(event)"
                            id="postcode" name="postcode" required="" maxlength="5" readonly="" value="<?php echo $item[0]['postcode'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            name="phone" required="" onkeypress="validate(event)" value="<?php echo $item[0]['phone'] ?>">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            name="state" required="" readonly="true" value="<?php echo $item[0]['state'] ?>">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            name="city" required="" value="<?php echo $item[0]['city'] ?>">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            name="address" required="" value="<?php echo $item[0]['address'] ?>">
                        </div>
                    </div>
